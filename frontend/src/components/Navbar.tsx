...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 md:gap-8 w-full md:w-auto text-sm md:text-base font-bold text-gray-400">
        <Link to="/" className="hover:text-blue-400 transition-colors">Home</Link>
        <Link to="/products" className="hover:text-blue-400 transition-colors">Coaches & Tactics</Link>
        <Link to="/store" className="hover:text-blue-400 transition-colors">Account Store</Link>
        <Link to="/leaderboard" className="hover:text-blue-400 transition-colors">Creator Board</Link>
