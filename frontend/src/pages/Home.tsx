...
function StatCard({ value, label, sub }: { value: string; label: string; sub: string }) {
  return (
    <div className="group flex flex-col items-center gap-1 px-6 py-4 rounded-2xl bg-gray-900/80 backdrop-blur-md border border-gray-800 shadow-sm hover:border-blue-500/40 hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all duration-300">
...
function SectionTitle({ en, ar, accent }: { en: string; ar: string; accent?: string }) {
  return (
    <div className="text-center mb-12 md:mb-16">
      ...
      <div className="mt-4 mx-auto w-16 h-1 bg-gradient-to-r from-blue-500 to-green-500 rounded-full" />
    </div>
  );
}
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#030510] text-gray-100 font-sans" dir="rtl">
      ...
      <section ref={heroRef} className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-20"
        ...
        {/* Dark Overlay over the background to make text readable but keep colors vibrant */}
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-6">
          ...
          <div className="w-full md:w-1/2 text-right">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 mb-5 px-4 py-2 rounded-full bg-blue-900/30 border border-blue-800 shadow-sm backdrop-blur-md">
            ...
            <div ref={headingRef}>
              ...
              <h1 className="text-5xl sm:text-6xl md:text-8xl font-black leading-none tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-400 mb-6 drop-shadow-lg">
                DOMINATE.
              </h1>
            </div>
      ...
      {/* ── F9 EXPERIENCE ───────────────────────────────────────────────────── */}
      <section className="relative py-24 px-4 bg-[#030510] border-t border-gray-900">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {EXPERIENCES.map((ex) => (
              <div key={ex.num}
                className="reveal-up group relative p-8 rounded-2xl bg-gray-900/50 backdrop-blur-sm border border-gray-800 shadow-sm hover:border-blue-500/50 hover:shadow-[0_0_20px_rgba(59,130,246,0.15)] transition-all duration-500 hover:-translate-y-2 overflow-hidden cursor-default">
                ...
                <span className="text-4xl block mb-4 relative z-10 drop-shadow-md">{ex.icon}</span>
      ...
      {/* ── STORE SECTION ───────────────────────────────────────────────────── */}
      {products.length > 0 && (
        <section className="relative py-24 px-4 bg-gray-950/50 border-t border-gray-900">
          <div className="max-w-6xl mx-auto">
            <div className="reveal-up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {products.map(p => (
                <div key={p.id}
                  className="reveal-up group relative rounded-2xl overflow-hidden bg-gray-900/50 border border-gray-800 shadow-sm hover:border-green-500/50 hover:shadow-[0_0_20px_rgba(34,197,94,0.15)] transition-all duration-400 hover:-translate-y-2">
      ...
      <section className="relative py-24 px-4 bg-gray-950/50 border-t border-gray-900 overflow-hidden">
        {/* Glow behind CTA */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-[300px] bg-gradient-to-r from-blue-900/20 to-green-900/20 blur-[100px] pointer-events-none" />
        ...
        <div className="relative max-w-3xl mx-auto text-center reveal-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="https://t.me/fouadf9" target="_blank" rel="noreferrer"
              className="px-8 py-4 rounded-xl bg-gradient-to-r from-blue-600 to-green-600 hover:from-blue-500 hover:to-green-500 text-white font-bold shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_30px_rgba(34,197,94,0.4)] hover:-translate-y-1 transition-all duration-300">
              ✈ انضم للمجتمع
            </a>
            <a href="https://www.youtube.com/@fouadf9/" target="_blank" rel="noreferrer"
              className="px-8 py-4 rounded-xl bg-gray-900/80 backdrop-blur-sm border-2 border-red-900/50 text-red-500 font-bold hover:bg-red-900/20 hover:border-red-500 shadow-sm hover:shadow-[0_0_15px_rgba(239,68,68,0.2)] hover:-translate-y-1 transition-all duration-300">
              ▶ اشترك على YouTube
            </a>
          </div>
        </div>
